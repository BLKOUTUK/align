...
export function generateFeedback(scores) {
  ...
  lines.push('');
  lines.push('This feedback was generated using Assess & Align, a tool developed by the Black Mental Health & Wellbeing Alliance to support equitable research partnerships.');
  lines.push('');
